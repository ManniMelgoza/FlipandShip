...
import CreateWishlistModal from "../ManageWishlists/CreateWishlistModal";
...
function ManageWishlists() {
  ...
  <>
    <div className="landing-container">
      ...
      <div className="create-wishlist-buttons">
        <OpenModalButton
          buttonText="➕ New Wishlist"
          modalComponent={<CreateWishlistModal />}
        />
      </div>
                ...
                <div key={wishlist.id} className="listing-card">
                  ...
                  <div className="wishlist-card-buttons">
                    <OpenModalButton
                      ...
                      modalComponent={<EditWishlistModal wishlist={wishlist} />}
                    />
                    <OpenModalButton
                      buttonText="Delete"
                      className="quick-view"
