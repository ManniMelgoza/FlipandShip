    ...
    switch (action.type) {
        ...
        case GET_CURRENT_USER_LISTINGS: {
            ...
            action.payload.forEach(listing => {
                userListings[listing.id] = listing;
            });
            return { ...state, listings: userListings };
        }
        ...
        case DELETE_LISTING: {
        const deleteListings = { ...state.listings };
        delete deleteListings[action.payload];
        return { ...state, listings: deleteListings };
        }
