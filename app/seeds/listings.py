...
def seed_listings():
    ...
    listings = [
        # Denver - owner_id 1
        Listing(owner_id=1, item_title="Tripod Manfrotto", price=250, description="Lightweight yet sturdy Manfrotto tripod in excellent condition. Adjustable height, quick-release plate, and smooth panning head. Perfect for photography or videography.", location='80209', brand="Manfrotto", color="Black", quantity=4, condition_id=None, category_id=None),
        Listing(owner_id=1, item_title="Pro Gear Toolbox", price=120, description="Durable toolbox with secure latches and spacious compartments. Includes wheels for better handling. Ideal for storing hand tools or organizing your workspace. Light wear but fully functional.", location='80238', brand="RIGID", color="Black", quantity=7, condition_id=None, category_id=None),
        Listing(owner_id=1, item_title="TLC TV 32in", price=60, description="32-inch TCL HDTV with crisp display and vibrant colors. Great for bedrooms, dorms, or gaming setups. Includes remote, excellent condition.", location='80204', brand="TLC", color="Black", quantity=2, condition_id=None, category_id=None),
        Listing(owner_id=1, item_title="Surge Protective Device", price=540, description="Reliable Square D MA1IMA161 Surge Protective Device (Type 1) for residential or commercial panels. Protects equipment from voltage spikes. Compact, durable, and ready for installation.", location='80219', brand="Square D", color="Black", quantity=10, condition_id=None, category_id=None),


        # Aurora - owner_id 2
        Listing(owner_id=2, item_title="Specialized Bike", price=180, description="High-quality Specialized road bike with lightweight frame and smooth gear shifting. Ready for commuting, exercise, or weekend rides.", location='80013', brand="Specialized", color="Green", quantity=3, condition_id=None, category_id=None),
        Listing(owner_id=2, item_title="Saw Milwaukee", price=89, description="Powerful Milwaukee electric saw in good working condition. Cuts through wood and metal with ease — perfect for DIY or professional projects.", location='80010', brand="Milwaukee", color="Red", quantity=6, condition_id=None, category_id=None),
        Listing(owner_id=2, item_title="Samsung Stove", price=220, description="Stainless steel Samsung electric stove with smooth glass cooktop and spacious oven. Clean, fully tested, and ready for your kitchen.", location='80012', brand="Samsung", color="Black", quantity=1, condition_id=None, category_id=None),
        Listing(owner_id=2, item_title="Samsung Microwave", price=110, description="Compact yet powerful Samsung microwave with multiple cooking settings. Excellent condition and easy to clean.", location='80017', brand="Samsung", color="Black", quantity=5, condition_id=None, category_id=None),

        # Centennial - owner_id 3
        Listing(owner_id=3, item_title="Ryobi Drill", price=20, description="Cordless Ryobi drill with variable speed control and ergonomic grip. Battery included, ready for any home or work project.", location='80122', brand="Ryobi", color="Blue", quantity=8, condition_id=None, category_id=None),
        Listing(owner_id=3, item_title="Ray-Ban Glasses", price=145, description="Authentic Ray-Ban sunglasses in classic style. UV protection lenses, minimal wear, and includes carrying case.", location='80015', brand="Ray-Ban", color="Black/Gold", quantity=3, condition_id=None, category_id=None),
        Listing(owner_id=3, item_title="Hand-Held Test Kit Masterpact / PowerPact", price=650, description="S33594 Hand-Held Test Kit for Masterpact® and PowerPact® breakers. Portable, accurate, and built for durability. Includes multilingual labels in English, Spanish, and French. Excellent condition.", location='80121', brand="Square D", color="Black", quantity=9, condition_id=None, category_id=None),
        Listing(owner_id=3, item_title="Bell & Gossett P5001889 Seal Kit", price=540, description="Bell & Gossett P5001889 Seal Kit for 2in Series VSX pumps. Made with EPR, carbon, and silicon carbide for durability, chemical resistance, and long service life. Ensures a perfect fit for reliable pump performance in HVAC and industrial use.", location='80123', brand="Bell & Gossett", color="Silver/Black", quantity=2, condition_id=None, category_id=None),

        # Thornton - owner_id 4
        Listing(owner_id=4, item_title="Milwaukee Nailer", price=102, description="Heavy-duty Milwaukee nail gun in excellent working order. Fires smoothly and reliably — perfect for framing or carpentry projects.", location='80221', brand="Milwaukee", color="Red", quantity=6, condition_id=None, category_id=None),
        Listing(owner_id=4, item_title="Milwaukee Battery 2.0 Amp", price=77, description="Genuine Milwaukee 2.0Ah rechargeable battery. Holds full charge and compatible with M18 tools.", location='80229', brand="Milwaukee", color="Red", quantity=7, condition_id=None, category_id=None),
        ...
        Listing(owner_id=4, item_title="Milwaukee Impact Drill", price=166, description="Milwaukee cordless impact driver with high torque performance. Ideal for tough fastening jobs. Fully functional.", location='80241', brand="Milwaukee", color="Red", quantity=4, condition_id=None, category_id=None),

        # Northglenn - owner_id 5
        Listing(owner_id=5, item_title="KitchenAid Mixer", price=190, description="Iconic KitchenAid stand mixer in working condition. Powerful motor, multiple speeds — perfect for baking or cooking enthusiasts.", location='80234', brand="KitchenAid", color="Red", quantity=1, condition_id=None, category_id=None),
        Listing(owner_id=5, item_title="Milwaukee Impact Drill", price=147, description="Milwaukee cordless impact driver with high torque performance. Ideal for tough fastening jobs. Fully functional.", location='80233', brand="Milwaukee", color="Red", quantity=8, condition_id=None, category_id=None),
        Listing(owner_id=5, item_title="DRD2M Light", price=40, description="High-intensity DRD2M light fixture — great for workspaces or photography. Minimal wear, works perfectly.", location='80241', brand="DMF Lighting", color="Black/White", quantity=3, condition_id=None, category_id=None),
        Listing(owner_id=5, item_title="Bose Headphones", price=200, description="Bose over-ear headphones with noise-canceling technology. Crisp sound, comfortable fit, excellent condition.", location='80260', brand="Bose", color="Black", quantity=9, condition_id=None, category_id=None),
        ...
        Listing(owner_id=9, item_title="Snowboard with Bindings", price=170, description="All-mountain snowboard with adjustable bindings. Ready for the slopes this winter.", location='80522', brand="Burton", color="White", quantity=2, condition_id=None, category_id=None),
        Listing(owner_id=9, item_title="Smartwatch", price=48, description="Smartwatch with fitness tracking, notifications, and customizable faces. Works perfectly.", location='80525', brand="Fitbit", color="Black", quantity=9, condition_id=None, category_id=None),
        ...
        # Cherry Creek/Sheridan/Greenwood Village/Englewood - owner_id 10
